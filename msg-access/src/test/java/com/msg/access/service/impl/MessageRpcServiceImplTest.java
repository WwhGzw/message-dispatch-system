...
/**
 * MessageRpcServiceImpl 单元测试
 * 验证 Dubbo RPC 实现正确委托到核心服务
 */
...
class MessageRpcServiceImplTest {
    ...
    private MessageRpcServiceImpl rpcService;

    @BeforeEach
    void setUp() {
        rpcService = new MessageRpcServiceImpl(messageCenterService, receiptService);
    }
    ...
    void sendNow_delegatesToMessageCenterService() {
        ...
        SendResult result = rpcService.sendNow(request);
    ...
    void sendDelay_delegatesToMessageCenterService() {
        ...
        SendResult result = rpcService.sendDelay(request);
    ...
    void queryStatus_delegatesToMessageCenterService() {
        ...
        MessageStatusVO result = rpcService.queryStatus(query);
    ...
    void cancel_delegatesToMessageCenterService() {
        ...
        CancelResult result = rpcService.cancel(request);
    ...
    void handleReceipt_delegatesToReceiptService() {
        ...
        rpcService.handleReceipt(callback);
